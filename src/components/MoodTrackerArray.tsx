...
// import { useMoodStore, type Mood } from "@/lib/mood-store";
          ...
          {MOODS.map(({ key, label, icon: Icon, color }) => {
            ...
            return (
              <Button
                ...
                className={cn(
                  "flex items-center gap-2 rounded-full px-4 cursor-pointer",
                  selected && color,
                  selected && "border"
                )}
              >
        ...
        <section aria-labelledby="current-mood-heading" className="grid gap-3">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              {currentMood === "" ? "No mood yet" : currentMood}
            </Badge>
...
export default MoodTrackerArray;
